...
async function seedCategories() {
  ...
  console.log(
    `✅ ${defs.length} catégories + ${ACCESSORY_SUBCATEGORIES.length} sous-catégories`,
  );
  return map;
}
...
async function seedProducts(
  ...
  console.log(
    `✅ ${products.length} produits (${BAGS.length} sacs, ${ACCESSORIES.length} accessoires, ${PREORDERS.length} précommandes)`,
  );
  return products;
}
...
async function seedCoupons() {
  ...
  const defs = [
    {
      code: "BIENVENUE10",
      description: "-10% première commande",
    ...
    {
      code: "SACS5000",
      description: "-5000 FCFA dès 30000 FCFA",
      type: "FIXED" as const,
      value: 5000,
      minPurchase: 30000,
      usageLimit: 200,
  ...
  const samples = [
    {
      rating: 5,
      title: "Excellent",
      body: "Qualité au top, livraison rapide.",
      isApproved: true,
    },
    {
      rating: 4,
      title: "Très bien",
      body: "Conforme à la description.",
      isApproved: true,
    },
    {
      rating: 3,
      title: "Correct",
      body: "Bon produit mais un peu petit.",
      isApproved: false,
    },
  ];
  let n = 0;
...
async function seedCart(products: SeedProduct[], users: SeedUsers) {
  ...
  console.log(
    `✅ 1 panier actif (${users.customers[0].email}, ${inStock.length} articles)`,
  );
  return cart;
}
...
async function seedInventory(products: SeedProduct[]) {
  ...
  for (const p of targets) {
    ...
    await prisma.inventory.create({
      data: { productId: p.id, quantity: -3, type: "SALE", note: "Ventes" },
    });
    n += 2;
  }
...
async function seedCampaigns(products: SeedProduct[]) {
  ...
  const defs = [
    {
      name: "Nouveautés sacs",
      type: "EMAIL" as const,
      subject: "Découvrez nos nouveaux sacs",
      content: "<h1>Nouvelle collection</h1>",
    ...
    },
    {
      ...
      content: "Profitez de -10% avec BIENVENUE10",
    ...
    },
    {
      name: "Brouillon SMS",
      type: "SMS" as const,
      content: "Message en préparation",
  ...
  for (const d of defs) {
    await prisma.campaign.create({
      data: { ...d, products: { create: featured } },
    });
    n++;
  }
  ...
  const defs = [
    {
      ...
      occasion: "Mariage",
      eventDate: new Date(Date.now() + 21 * 24 * 3600 * 1000),
      location: "domicile",
      guests: 4,
      budget: "50 000 – 100 000 F",
      message: "Préparation de la mariée et 3 demoiselles.",
      status: "NEW" as const,
    },
    {
      name: "Awa B.",
    ...
    },
    {
      ...
      services: ["Tresses & Extensions", "Soins du visage"],
      occasion: "Shooting photo",
      location: "salon",
      guests: 2,
      budget: "25 000 – 50 000 F",
      status: "QUOTED" as const,
      adminNote: "Devis envoyé par WhatsApp.",
    },
  ];
  let n = 0;
  for (const d of defs) {
  ...
  const defs = [
    {
      ...
      imageUrl: "https://placehold.co/1200x500/1e293b/ffffff?text=Collection",
      linkUrl: "/sacs",
      altText: "Collection",
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      imageUrl: "https://placehold.co/1200x500/831843/ffffff?text=Salon",
      linkUrl: "/salon",
      altText: "Salon",
      sortOrder: 2,
      isActive: true,
    ...
    {
      title: "-10% BIENVENUE10",
      subtitle: "Sur votre 1ère commande",
      imageUrl: "https://placehold.co/1200x500/166534/ffffff?text=Promo",
      linkUrl: "/accessoires",
      altText: "Promo",
      sortOrder: 3,
      isActive: true,
  ...
  const defs = [
    {
      ...
      answer: "Livraison à Abidjan sous 24 à 48h.",
      sortOrder: 1,
      isActive: true,
    },
    {
      question: "Quels moyens de paiement acceptez-vous ?",
      answer: "Espèces, Mobile Money, carte bancaire et virement.",
      sortOrder: 2,
      isActive: true,
    },
    {
      question: "Puis-je retourner un article ?",
      answer: "Oui, sous 7 jours si l’article est intact.",
      sortOrder: 3,
      isActive: true,
    },
    {
      question: "Proposez-vous des prestations à domicile ?",
      answer: "Oui, le salon se déplace pour les mariages et événements.",
      sortOrder: 4,
      isActive: true,
    },
  ];
  ...
  const defs = [
    {
      ...
      description: "Nos réalisations coiffure.",
      sortOrder: 1,
      images: [
        "https://placehold.co/600x600/be123c/fff?text=Coiffure+1",
        "https://placehold.co/600x600/9f1239/fff?text=Coiffure+2",
      ],
    },
    {
      title: "Maquillage",
      description: "Make-up jour et soirée.",
      sortOrder: 2,
      images: ["https://placehold.co/600x600/a21caf/fff?text=Makeup+1"],
    },
    {
      title: "Onglerie",
      description: "Nail art et poses gel.",
      sortOrder: 3,
      images: [
        "https://placehold.co/600x600/7c3aed/fff?text=Ongles+1",
        "https://placehold.co/600x600/6d28d9/fff?text=Ongles+2",
      ],
    },
  ];
  for (const d of defs) {
